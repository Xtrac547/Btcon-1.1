...
import { ArrowUpRight, ArrowDownLeft, Settings, X, QrCode, Camera, Copy, RefreshCw, Coins } from 'lucide-react-native';
      ...
      <View style={styles.topBar}>
        <View style={styles.leftButtons}>
          ...
          >
            ...
            >
              <RefreshCw color="#FF8C00" size={24} />
            </Animated.View>
          </TouchableOpacity>
